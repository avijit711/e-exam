<?php
  ...
  if (isset($_POST['signin'])) {
    ...
    $check = "SELECT admin_id, email, pw FROM admininfo WHERE email = '$mail' AND pw = '$pw'";
    ...
    if ($user == false) {
      ...
      $_SESSION['active_admin'] = $user['admin_id'];
    ...
    <div class="main_body">
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          ...
          <p class="alert alert-info">Don't Have a admin ID??? Go to <strong> <a href="admin.signup.php">Register</a> </strong></p>
        </div>
        <div class="col-sm-3"></div>
      </div>
    </div><br><br>
